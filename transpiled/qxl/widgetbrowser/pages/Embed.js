    ...
    members: {
      ...
      initWidgets: function initWidgets() {
        ...
        if (qx.core.Environment.get("html.canvas")) {
          ...
          this.__grid.add(canvas, {
            row: 3,
            column: 0
          });
        } else {
          this.__grid.add(new qx.ui.basic.Label("Browser does not support canvas"), {
            row: 3,
            column: 0
          });
        } // HTML
...
//# sourceMappingURL=Embed.js.map?dt=1567680098381