  ...
  qx.Class.define("qxl.widgetbrowser.pages.List", {
    ...
    members: {
      ...
      initWidgets: function initWidgets() {
        ...
        this.__grid.add(groupedVirtualList, {
          row: 1,
          column: 2
        });
      ...
      __getGroupedVirtualList: function __getGroupedVirtualList() {
        var list = this.__getVirtualList(); // Creates the delegate for sorting and grouping
...
//# sourceMappingURL=List.js.map?dt=1567680098186