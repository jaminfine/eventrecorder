    ...
    members: {
      ...
      __fillPackageNode: function __fillPackageNode(treeNode, docNode, depth) {
        ...
        qx.Promise.map(packagesDoc, packageDoc => {
          ...
          packageTreeNode.addListener("changeOpen", this.__getPackageNodeOpener(packageTreeNode, packageDoc, depth + 1), this); // Register the tree node
...
//# sourceMappingURL=PackageTree.js.map?dt=1567680097852