  ...
  qx.Class.define("qxl.formdemo.FormItems", {
    ...
    members: {
      ...
      _createView: function _createView() {
        ...
        this.__widgets.push(selectBox); // virtual select box
        ...
        this.__widgets.push(virtualSelectBox); // list
        ...
        this.__widgets.push(list); // radio button group
        ...
        this.__widgets.push(button); // toggle button
        ...
        this.__widgets.push(toggleButton); // toggle button
        ...
        this.__widgets.push(repeatButton); // menu button


        var menuButton = new qx.ui.form.MenuButton("MenuButton", null, this.__createMenuForMenuButton()).set({
          tabIndex: tabIndex++
        });
        ...
        this.__widgets.push(menuButton); // split button


        var splitButton = new qx.ui.form.SplitButton("SplitButton", null, this.__createMenuForSplitButton()).set({
          tabIndex: tabIndex++
        });
        ...
        this.__widgets.push(splitButton); // Listener
        ...
        this.__widgets.push(checkBox); // tri-state check box
        ...
        this.__widgets.push(triCheckBox); // radio button
        ...
        this.__widgets.push(spinner); // slider
...
//# sourceMappingURL=FormItems.js.map?dt=1567680098640