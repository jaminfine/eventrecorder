  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.data.MRemoteBinding", {
    ...
    members: {
       ...
       * @private
       */
      __tearDown: function __tearDown() {
        var properties = this._getDefaultPropertyNamesToSync();
      ...
      __broadcastEvent: function __broadcastEvent(type, data, oldData) {
        this.__channels.forEach(function (channelData) {
          ...
          var changedProperty = this.__computePropertyNameFromEventType(type); // do not retransmit message to its origin
       ...
       * @private
       */
      __sendEventMessage: function __sendEventMessage(channel, type, data, oldData) {
       ...
       * @private
       */
      __sendMessage: function __sendMessage(channel, message) {
       ...
       * @private
       */
      __getChannelOptions: function __getChannelOptions(channel) {
       ...
       * @private
       */
      __sendReadyEvent: function __sendReadyEvent(channel) {
...
//# sourceMappingURL=MRemoteBinding.js.map?dt=1567680076729