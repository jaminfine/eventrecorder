  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.window.RemoteApplication", {
    ...
    construct: function construct(uri, config, name) {
      ...
      this.__window = qx.bom.Window.open(url, window_name, config); // close popup window when main application unloads
...
//# sourceMappingURL=RemoteApplication.js.map?dt=1567680095664